...
* Look at open issues tagged with ["help wanted"](https://github.com/fredshone/caveat/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) and ["good first issue"](https://github.com/fredshone/caveat/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
* Look at the [contributing guide in our documentation](https://fredshone.github.io/caveat/contributing)

## Licensing
By contributing to caveat, i.e. through opening a pull request, you represent that your contributions are your own original work and that you have the right to license them, and you agree that your contributions are licensed under the MIT license.
## Reporting bugs and requesting features

You can open an issue on GitHub to report bugs or request new caveat features.
Follow these links to submit your issue:

- [Report bugs or other problems while running caveat](https://github.com/fredshone/caveat/issues/new?template=BUG-REPORT.yml).
If reporting an error, please include a full traceback in your issue.

- [Request features that caveat does not already include](https://github.com/fredshone/caveat/issues/new?template=FEATURE-REQUEST.yml).

- [Report missing or inconsistent information in our documentation](https://github.com/fredshone/caveat/issues/new?template=DOCS.yml).

- [Any other issue](https://github.com/fredshone/caveat/issues/new).

## Submitting changes

Look at the [development guide in our documentation](https://fredshone.github.io/caveat/contributing) for information on how to get set up for development.
...
6. On GitHub, create a new [pull request](https://github.com/fredshone/caveat/pull/new/main) from the feature branch.
...
- [ ] Bump the version number in `caveat/__init__.py`
...
- [ ] Update `caveat/__init__.py` to the next version appended with `.dev0`, in preparation for the next main commit.
